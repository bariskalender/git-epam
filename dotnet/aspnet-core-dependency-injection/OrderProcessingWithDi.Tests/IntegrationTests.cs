...
public class IntegrationTests(WebApplicationFactory<Program> factory) : IClassFixture<WebApplicationFactory<Program>>
{
    ...
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=A1&quantity=6&unitPrice=10", null);
    ...
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=B2&quantity=4&unitPrice=10", null);
    ...
    [Fact]
    public async Task PostOrder_EmptyProductId_ReturnsInternalServerError()
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=&quantity=5&unitPrice=10", null);
        
        // Assert
        // OrderService throws ArgumentException which results in 500 error
        Assert.Equal(HttpStatusCode.InternalServerError, response.StatusCode);
    }
    
    [Fact]
    public async Task PostOrder_ZeroQuantity_ReturnsInternalServerError()
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=C3&quantity=0&unitPrice=10", null);
    ...
    [Fact]
    public async Task PostOrder_NegativeQuantity_ReturnsInternalServerError()
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=C3&quantity=-5&unitPrice=10", null);
    ...
    [Fact]
    public async Task PostOrder_ZeroUnitPrice_ReturnsInternalServerError()
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=C3&quantity=5&unitPrice=0", null);
    ...
    [Fact]
    public async Task PostOrder_NegativeUnitPrice_ReturnsInternalServerError()
    {
        // Arrange & Act
        var response = await client.PostAsync("/orders?productId=C3&quantity=5&unitPrice=-10", null);
    ...
    {
        // Arrange & Act
        var response1 = await client.PostAsync("/orders?productId=D1&quantity=2&unitPrice=5", null);
        var response2 = await client.PostAsync("/orders?productId=D2&quantity=3&unitPrice=7", null);
        var response3 = await client.PostAsync("/orders?productId=D3&quantity=4&unitPrice=9", null);
        ...
        // Get all orders
        var getAllResponse = await client.GetAsync("/orders");
    ...
    {
        // Arrange
        await client.PostAsync("/orders?productId=E1&quantity=5&unitPrice=10", null);
        await client.PostAsync("/orders?productId=E2&quantity=3&unitPrice=15", null);
    ...
    public async Task GetOrders_DemonstratesSingletonLifetime()
    {
        ...
        await client.PostAsync("/orders?productId=F1&quantity=1&unitPrice=10", null);
        await client.PostAsync("/orders?productId=F2&quantity=2&unitPrice=20", null);
        
        // Act - Get orders multiple times
        var response1 = await client.GetAsync("/orders");
        var response2 = await client.GetAsync("/orders");
    ...
    {
        // Act
        var response = await client.GetAsync("/di-demo");
    ...
    {
        // Act
        var response1 = await client.GetAsync("/di-demo");
        var response2 = await client.GetAsync("/di-demo");
    ...
    {
        // Act
        var response = await client.GetAsync("/factory-demo?price=10&quantity=6&serviceType=standard");
    ...
    {
        // Act
        var response = await client.GetAsync("/factory-demo?price=10&quantity=6&serviceType=simple");
    ...
    {
        // Act
        var response = await client.GetAsync("/factory-demo?price=10&quantity=5");
    ...
    {
        // Act
        var response = await client.GetAsync("/factory-demo?price=10&quantity=5&serviceType=invalid");
