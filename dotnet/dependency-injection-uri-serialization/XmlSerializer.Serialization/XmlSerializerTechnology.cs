...
namespace XmlSerializer.Serialization
{
    public class XmlSerializerTechnology : IDataSerializer<Uri>
    {
        ...
        public XmlSerializerTechnology(string path)
        {
            this.path = path;
        }

        public XmlSerializerTechnology(string path, Microsoft.Extensions.Logging.ILogger<XmlSerializerTechnology> logger)
        {
            this.path = path;
        }
