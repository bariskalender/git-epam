...
namespace PalindromeNumberFiltering.Tests
{
    ...
    //Thıs project is licansed under the MIT License (MIT). See LICENSE in the repository root for more information.
    //And also thıs is learnıng materıal for me , so I would be very happy if you colud give me feedback or suggestıons about my code.
    // Generally  maın ıdea of thıs project is to fılter polındrımıc numbers from agiven array of ınts, I have implemented approaches for thıs problem and I have also implemented tests for each approach to ensure the correctness of the code and to compare the performance of each approach. I have used NUnit framework for testing and I have also included a performance test to measure the execution time of the method when processing a large array. I would appreciate any feedback or suggestions you may have to improve my code or to optimize the performance further.
    // For students who are learning C#, They might struggle with readıng and understandıng the code , so I have tried to write clear and concise code with meanıngful varıable names and  I have also included comments to explain the logic behind the code . I hope this will help students to understand the code better and to learn from it .
}
