...
# Run the application
dotnet run --project OrderProcessingEnvironments

# Or with explicit environment
ASPNETCORE_ENVIRONMENT=Development dotnet run --project OrderProcessingEnvironments
```
...
└── OrderProcessingEnvironments.csproj  # References OrderProcessingWithDi project
```

**Note:** This project references `OrderProcessingWithDi` to reuse all its models, services, and middleware.
...
| Aspect | OrderProcessingWithDi | OrderProcessingEnvironments |
|--------|----------------------|----------------------------|
| **Port** | 5000 | 5001 |
