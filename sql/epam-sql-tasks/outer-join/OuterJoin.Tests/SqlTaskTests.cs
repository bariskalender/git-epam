...
namespace OuterJoin.Tests
{
    ...
    public class SqlTaskTests
    {
        ...
        public void Setup()
        {
            ...
            // SqliteHelper.OpenConnection(this.emptyDatabaseFile, databaseFile);
            // InsertData();
        ...
        [Test]
        public void SelectQueryContainsWhereIsNull([Range(1, FilesCount)] int index)
        {
            var actual = this.queriesArray[index - 1];
        ...
        [Test]
        public void SelectQueryContainsLeftJoin([Range(1, FilesCount)] int index)
        {
            var actual = this.queriesArray[index - 1];
        ...
        [TestCase(3)]
        public void SelectQueryContainsUnion(int index)
        {
            var actual = this.queriesArray[index - 1];
