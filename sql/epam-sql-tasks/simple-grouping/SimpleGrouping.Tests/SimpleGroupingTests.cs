...
{
    [TestFixture]
    public class SimpleGroupingTests
    {
        ...
        [Test]
        public void SelectQueryContainsGroupBy([Range(1, FilesCount)] int index)
        {
            var actual = this.queriesArray[index - 1];
        ...
        [Test]
        public void SelectQueryContainsSubqueriesFalse([Range(1, FilesCount)] int index)
        {
            var actual = this.queriesArray[index - 1];
