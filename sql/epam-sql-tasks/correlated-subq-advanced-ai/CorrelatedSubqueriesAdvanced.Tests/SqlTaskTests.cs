...
using CorrelatedSubqueriesAdvanced;
...
namespace CorrelatedSubqueriesAdvanced.Tests
{
    ...
    public class SqlTaskTests
    {
        ...
        public SqlTaskTests()
        {
            ...
            this.queryFiles = SqlTask.GetFilePaths(FileType.Sql, this.fileNames);
        ...
        [Test]
        public void AllSelectQueriesExecuteSuccessfully([Range(1, FilesCount)] int index)
        {
